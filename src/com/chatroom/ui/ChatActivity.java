...
public class ChatActivity {
	...
	public ChatActivity(ClientModel clientModel) throws IOException {
		...
		try {
			request = new Request(Request.Type.GET_HISTORY.ordinal(), clientModel.getClientID(), clientModel.getRoomId(), "");
			ClientModel.objectOutputStream.writeObject(request);
			ClientModel.objectOutputStream.flush();
		} catch (IOException e) {
			LogFileWriter.Log("Error requesting history: " + e.getMessage());
		}
